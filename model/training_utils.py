...
def load_dataset(model_type, replica_num, index_name):
...
def predict_valid(device, model, dataloader_valid, criterion, istrain=True,
                  use_auxiliary=False, gamma_layer=None, gamma_subout=None,
                  use_atom_model=True, use_monomer_model=True, use_peptide_model=True,
                  ensemble=False,
                  visualization=False):
...
def train_loop(model_path, device, patience, epoch_num,
               ...
               optimizer, scheduler, use_earlystopping=True, verbose=False,
               use_auxiliary=False, gamma_layer=None, gamma_subout=None,
               use_atom_model=True, use_monomer_model=True, use_peptide_model=True,
               ensemble=False,
               visualization=False):
...
def load_dataset_cv(model_type, replica_num, cv):
    ...
    train_ids = np.load(f'data/train_ids_cv{cv}.npy')
    valid_ids = np.load(f'data/valid_ids_cv{cv}.npy')
